  ...
  <div >
    <div class="center" style="padding-left:1%; pedding-right:15%; padding-top:5%" >
      <button class="bigbttn length" style="text-align: center;">
        <div>
          <button class="smallbttn" visible v-b-toggle.accordion-1 >GİRİŞ</button>
          <button class="smallbttn"  v-b-toggle.accordion-2>KAYIT OL</button>
      ...
      <b-collapse id="accordion-1" visible accordion="my-accordion" role="tabpanel" > 
          <input type="email" placeholder="Mail Adresiniz" class="length"   v-model="form.email"/>
          <br /><br />
          <input type="password" placeholder="Şifreniz" class="length" v-model="form.password" />
          <br /><br />
          <div>
              <button class="smallbttn length" @click="signin" >GİRİŞ YAP</button>
            <br />
            <small class="txt" >Şifremi Unuttum</small>
            <br /><br />
            <div >
              <button class="btn">
                <img
      ...
      <b-collapse id="accordion-2" accordion="my-accordion" role="tabpanel" >
        <div>
          <input type="text" placeholder="Adınız" class="lengthn">
          <input type="text" placeholder="Soyadınız" class="lengthn">
        </div>
          <br>
