<template>
  <div >
    <div class="center" >
      ...
      <br /><br />
      <input type="email" placeholder="Mail Adresiniz" class="length" />
      <br /><br />
      <input type="password" placeholder="Şifreniz" class="length" />
      <br /><br />
      <div>
          <button class="smallbttn length">GİRİŞ YAP</button>
      <br />
